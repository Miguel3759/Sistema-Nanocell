...
if ($_POST['action'] == 'addCliente') {
  ...
  $query_insert = mysqli_query($conexion, "INSERT INTO cliente(ci, nombre, telefono, direccion, usuario_id) VALUES ('$ci','$nomnre','$telefono','$direccion','$usuario_id')");
  if ($query_insert) {
...
if ($_POST['action'] == 'addProductoDetalle') {
  if (empty($_POST['producto']) || empty($_POST['cantidad'])){
    ...
    $detalleTotales ='<tr>
        <td colspan="5" class="textright">Sub_Total Bs/.</td>
